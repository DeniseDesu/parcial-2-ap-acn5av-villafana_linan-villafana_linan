...
class ArticuloController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        ->with('status', 'El artículo se ha agregado correctamente' );
    }
    ...
    public function update(Request $request, Articulo $articulo)
    {
        ...
        return redirect()
        ->route('articulos.index')
        ->with('status', 'El artículo se ha modificado correctamente' ); //SE ESTABLECE PARA LOS METODOS UPDATE, DELETE Y STORE CON EL METODO WITH UNA ACCION QUE NOTIFIQUE UNA MODIFICACION EN LA DB. ESTO SE VISUALIZA EN EL INDEX A TRAVES DE UNA VARIABLE.
    }
    ...
    public function destroy(Articulo $articulo)
    {
        ...
        return redirect()
        ->route('articulos.index')
        ->with('status', 'El artículo se ha eliminado correctamente' );
    }
}
